...
public class TableComponent {
    ...
    private static final String API_URL = "sua_api_url_aqui"; // Altere para sua URL da API
    ...
    public <T> void loadData(String apiUrl, Class<T[]> clazz) {
        ...
        if (items instanceof Product[]) {
            configureProductTable(table);  // Configurações específicas para Produto
        }
//        else {
//            configureTable(table); // Configuração genérica
//        }
